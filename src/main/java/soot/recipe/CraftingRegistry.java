...
public class CraftingRegistry {
    ...
    public static void registerRecipes(RegistryEvent.Register<IRecipe> event) {
        ...
        RecipeRegistry.stampingRecipes.add(new ItemStampingRecipe(Ingredient.EMPTY, FluidRegistry.getFluidStack("copper", nuggetSize), Ingredient.fromItem(Registry.STAMP_NUGGET), new ItemStack(ItemRegister.NUGGET_COPPER)));
        RecipeRegistry.stampingRecipes.add(new ItemStampingRecipe(Ingredient.EMPTY, FluidRegistry.getFluidStack("dawnstone", nuggetSize), Ingredient.fromItem(Registry.STAMP_NUGGET), new ItemStack(ItemRegister.NUGGET_DAWNSTONE)));
        RecipeRegistry.stampingRecipes.add(new ItemStampingRecipe(Ingredient.EMPTY, FluidRegistry.getFluidStack("lead", nuggetSize), Ingredient.fromItem(Registry.STAMP_NUGGET),new ItemStack(ItemRegister.NUGGET_LEAD)));
        RecipeRegistry.stampingRecipes.add(new ItemStampingRecipe(Ingredient.EMPTY, FluidRegistry.getFluidStack("silver", nuggetSize), Ingredient.fromItem(Registry.STAMP_NUGGET),new ItemStack(ItemRegister.NUGGET_SILVER)));
        if (ConfigMaterial.TIN.isNotOff())
            RecipeRegistry.stampingRecipes.add(new ItemStampingRecipe(Ingredient.EMPTY, FluidRegistry.getFluidStack("tin", nuggetSize), Ingredient.fromItem(Registry.STAMP_NUGGET),new ItemStack(ItemRegister.NUGGET_TIN)));
        if (ConfigMaterial.ALUMINUM.isNotOff())
            RecipeRegistry.stampingRecipes.add(new ItemStampingRecipe(Ingredient.EMPTY, FluidRegistry.getFluidStack("aluminum", nuggetSize), Ingredient.fromItem(Registry.STAMP_NUGGET), new ItemStack(ItemRegister.NUGGET_ALUMINUM)));
        if (ConfigMaterial.BRONZE.isNotOff())
            RecipeRegistry.stampingRecipes.add(new ItemStampingRecipe(Ingredient.EMPTY, FluidRegistry.getFluidStack("bronze", nuggetSize), Ingredient.fromItem(Registry.STAMP_NUGGET),new ItemStack(ItemRegister.NUGGET_BRONZE)));
        if (ConfigMaterial.NICKEL.isNotOff())
            RecipeRegistry.stampingRecipes.add(new ItemStampingRecipe(Ingredient.EMPTY, FluidRegistry.getFluidStack("nickel", nuggetSize), Ingredient.fromItem(Registry.STAMP_NUGGET),new ItemStack(ItemRegister.NUGGET_NICKEL)));
        if (ConfigMaterial.ELECTRUM.isNotOff())
            RecipeRegistry.stampingRecipes.add(new ItemStampingRecipe(Ingredient.EMPTY, FluidRegistry.getFluidStack("electrum", nuggetSize), Ingredient.fromItem(Registry.STAMP_NUGGET),new ItemStack(ItemRegister.NUGGET_ELECTRUM)));
        ...
        if (ConfigMaterial.TIN.isNotOff()) //Tin sometimes doesn't exist.
