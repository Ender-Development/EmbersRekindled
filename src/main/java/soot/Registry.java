...
public class Registry {
    ...
    public static void initResearches() {
        ...
        subCategoryAlchemyMixing.addResearch(new ResearchShowItem("metal_leveling",ItemStack.EMPTY,7,4).addItem(new ResearchShowItem.DisplayItem(new ItemStack(ItemRegister.INGOT_LEAD),new ItemStack(ItemRegister.INGOT_TIN),new ItemStack(Items.IRON_INGOT),new ItemStack(ItemRegister.INGOT_COPPER),new ItemStack(ItemRegister.INGOT_SILVER),new ItemStack(Items.GOLD_INGOT))).setIconBackground(PAGE_ICONS,PAGE_ICON_SIZE*1,PAGE_ICON_SIZE*0).addAncestor(alchemy_globe));
