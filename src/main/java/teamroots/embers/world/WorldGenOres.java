...
public class WorldGenOres implements IWorldGenerator {
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        ...
        if (ConfigMaterial.COPPER.mustLoad() && ConfigWorld.ORE.COPPER.generate) {
            WorldGenMinable ore_copper = new WorldGenMinable(BlockRegister.ORE_COPPER.getDefaultState(), ConfigWorld.ORE.COPPER.veinSize);
        ...
        if (ConfigMaterial.LEAD.mustLoad() && ConfigWorld.ORE.LEAD.generate) {
            WorldGenMinable ore_lead = new WorldGenMinable(BlockRegister.ORE_LEAD.getDefaultState(), ConfigWorld.ORE.LEAD.veinSize);
        ...
        if (ConfigMaterial.SILVER.mustLoad() && ConfigWorld.ORE.SILVER.generate) {
            WorldGenMinable ore_silver = new WorldGenMinable(BlockRegister.ORE_SILVER.getDefaultState(), ConfigWorld.ORE.SILVER.veinSize);
        ...
        if (ConfigWorld.ORE.QUARTZ.generate) {
            WorldGenMinable ore_quartz = new WorldGenMinable(BlockRegister.ORE_QUARTZ.getDefaultState(), ConfigWorld.ORE.QUARTZ.veinSize);
        ...
        if (ConfigMaterial.ALUMINUM.mustLoad() && ConfigWorld.ORE.ALUMINUM.generate) {
            WorldGenMinable ore_aluminum = new WorldGenMinable(BlockRegister.ORE_ALUMINUM.getDefaultState(), ConfigWorld.ORE.ALUMINUM.veinSize);
        ...
        if (ConfigMaterial.NICKEL.mustLoad() && ConfigWorld.ORE.NICKEL.generate) {
            WorldGenMinable ore_nickel = new WorldGenMinable(BlockRegister.ORE_NICKEL.getDefaultState(), ConfigWorld.ORE.NICKEL.veinSize);
        ...
        if (ConfigMaterial.TIN.mustLoad() && ConfigWorld.ORE.TIN.generate) {
            WorldGenMinable ore_tin = new WorldGenMinable(BlockRegister.ORE_TIN.getDefaultState(), ConfigWorld.ORE.TIN.veinSize);
