...
import static teamroots.embers.register.RegistryManager.*;
...
public class BlockRegister implements IRegistrable<Block> {
    ...
    public static final Block ADVANCED_EDGE = new BlockAdvancedEdge(UNPUSHABLE, "advanced_edge", false).setIsFullCube(false).setIsOpaqueCube(false).setHarvestProperties("pickaxe", 0).setHardness(1.6f);
    ...
    public static final Block ARCHAIC_MECH_EDGE = new BlockMechEdge(UNPUSHABLE, "archaic_mech_edge", false).setIsFullCube(false).setIsOpaqueCube(false).setHarvestProperties("pickaxe", 0).setHardness(1.6f);
    ...
    public static final Block ASHEN_BRICK_SLAB_DOUBLE = new BlockDoubleSlabBase(Material.WOOD, "ashen_brick_slab_double", false, ASHEN_BRICK_SLAB).setHarvestProperties("pickaxe", 0).setHardness(1.6f).setLightOpacity(16);
    ...
    public static final Block ASHEN_STONE_SLAB_DOUBLE = new BlockDoubleSlabBase(Material.WOOD, "ashen_stone_slab_double", false, ASHEN_STONE_SLAB).setHarvestProperties("pickaxe", 0).setHardness(1.6f).setLightOpacity(16);
    ...
    public static final Block ASHEN_TILE_SLAB_DOUBLE = new BlockDoubleSlabBase(Material.WOOD, "ashen_tile_slab_double", false, ASHEN_TILE_SLAB).setHarvestProperties("pickaxe", 0).setHardness(1.6f).setLightOpacity(16);
    ...
    public static final Block BLOCK_ALCHEMICAL_REDSTONE = new BlockMolten(fluid_alchemical_redstone);
    ...
    public static final Block BLOCK_CAMINITE_BRICK_SLAB_DOUBLE = new BlockDoubleSlabBase(Material.WOOD, "block_caminite_brick_slab_double", false, BLOCK_CAMINITE_BRICK_SLAB).setHarvestProperties("pickaxe", 0).setHardness(1.6f).setLightOpacity(16);
    ...
    public static final Block BLOCK_MOLTEN_ALUMINUM = new BlockMolten(fluid_molten_aluminum);
    public static final Block BLOCK_MOLTEN_BRONZE = new BlockMolten(fluid_molten_bronze);
    public static final Block BLOCK_MOLTEN_COPPER = new BlockMolten(fluid_molten_copper);
    public static final Block BLOCK_MOLTEN_DAWNSTONE = new BlockMolten(fluid_molten_dawnstone);
    public static final Block BLOCK_MOLTEN_ELECTRUM = new BlockMolten(fluid_molten_electrum);
    public static final Block BLOCK_MOLTEN_GOLD = new BlockMolten(fluid_molten_gold);
    public static final Block BLOCK_MOLTEN_IRON = new BlockMolten(fluid_molten_iron);
    public static final Block BLOCK_MOLTEN_LEAD = new BlockMolten(fluid_molten_lead);
    public static final Block BLOCK_MOLTEN_NICKEL = new BlockMolten(fluid_molten_nickel);
    public static final Block BLOCK_MOLTEN_SILVER = new BlockMolten(fluid_molten_silver);
    public static final Block BLOCK_MOLTEN_TIN = new BlockMolten(fluid_molten_tin);
    ...
    public static final Block INFERNO_FORGE_EDGE = new BlockInfernoForgeEdge(UNPUSHABLE, "inferno_forge_edge", false).setIsFullCube(false).setIsOpaqueCube(false).setHarvestProperties("pickaxe", 0).setHardness(1.6f);
    ...
    public static final Block MECH_EDGE = new BlockMechEdge(UNPUSHABLE, "mech_edge", false).setIsFullCube(false).setIsOpaqueCube(false).setHarvestProperties("pickaxe", 0).setHardness(1.6f);
    ...
    public static final Block SEED_ALCHEMIC = Util.createSimpleSeed(Material.ROCK, "seed_alchemic", new ResourceLocation(Embers.MODID, "textures/blocks/material_alchemic.png"), (tile, i) -> new ItemStack(RegistryManager.alchemic_piece));
    public static final Block SEED_ALUMINUM = Util.createSimpleSeed(Material.ROCK, "seed_aluminum", new ResourceLocation(Embers.MODID, "textures/blocks/material_aluminum.png"), (tile, i) -> new ItemStack(RegistryManager.nugget_aluminum));
    public static final Block SEED_COPPER = Util.createSimpleSeed(Material.ROCK, "seed_copper", new ResourceLocation(Embers.MODID, "textures/blocks/material_copper.png"), (tile, i) -> new ItemStack(RegistryManager.nugget_copper));
    public static final Block SEED_DAWNSTONE = Util.createSimpleSeed(Material.ROCK, "seed_dawnstone", new ResourceLocation(Embers.MODID, "textures/blocks/material_dawnstone.png"), (tile, i) -> new ItemStack(RegistryManager.nugget_dawnstone));
    ...
    public static final Block SEED_LEAD = Util.createSimpleSeed(Material.ROCK, "seed_lead", new ResourceLocation(Embers.MODID, "textures/blocks/material_lead.png"), (tile, i) -> new ItemStack(RegistryManager.nugget_lead));
    public static final Block SEED_MITHRIL = Util.createSimpleSeed(Material.ROCK, "seed_mithril", new ResourceLocation(Embers.MODID, "textures/blocks/material_mithril.png"), (tile, i) -> new ItemStack(RegistryManager.nugget_mithril));
    public static final Block SEED_NICKEL = Util.createSimpleSeed(Material.ROCK, "seed_nickel", new ResourceLocation(Embers.MODID, "textures/blocks/material_nickel.png"), (tile, i) -> new ItemStack(RegistryManager.nugget_nickel));
    public static final Block SEED_SILVER = Util.createSimpleSeed(Material.ROCK, "seed_silver", new ResourceLocation(Embers.MODID, "textures/blocks/material_silver.png"), (tile, i) -> new ItemStack(RegistryManager.nugget_silver));
    public static final Block SEED_TIN = Util.createSimpleSeed(Material.ROCK, "seed_tin", new ResourceLocation(Embers.MODID, "textures/blocks/material_tin.png"), (tile, i) -> new ItemStack(RegistryManager.nugget_tin));
    ...
    public static final Block STONE_EDGE = new BlockStoneEdge(UNPUSHABLE, "stone_edge", true).setIsFullCube(false).setIsOpaqueCube(false).setHarvestProperties("pickaxe", 0).setHardness(1.6f);
    public static final Block STONE_VALVE = new BlockStoneValve(UNPUSHABLE, "stone_valve", true).setIsFullCube(false).setIsOpaqueCube(false).setHarvestProperties("pickaxe", 0).setHardness(1.6f);
    ...
    public void register(RegistryEvent.Register<Block> event) {
        ...
        if (ConfigMaterial.ALUMINUM.isNotOff()) {
            event.getRegistry().register(SEED_ALUMINUM);
            if (ConfigMaterial.ALUMINUM.mustLoad()) {
                event.getRegistry().register(BLOCK_ALUMINUM);
                event.getRegistry().register(ORE_ALUMINUM);
            }
        }
        if (ConfigMaterial.ASTRALITE.isNotOff()) {
            if (ConfigMaterial.ASTRALITE.mustLoad()) {
                event.getRegistry().register(BLOCK_ASTRALITE);
            }
        }
        if (ConfigMaterial.BRONZE.isNotOff()) {
            if (ConfigMaterial.BRONZE.mustLoad()) {
                event.getRegistry().register(BLOCK_BRONZE);
            }
        }
        if (ConfigMaterial.COPPER.isNotOff()) {
            event.getRegistry().register(SEED_COPPER);
        ...
        if (ConfigMaterial.DAWNSTONE.isNotOff()) {
            event.getRegistry().register(SEED_DAWNSTONE);
            if (ConfigMaterial.DAWNSTONE.mustLoad()) {
                event.getRegistry().register(BLOCK_DAWNSTONE);
            }
        }
        if (ConfigMaterial.ELECTRUM.isNotOff()) {
            if (ConfigMaterial.ELECTRUM.mustLoad()) {
                event.getRegistry().register(BLOCK_ELECTRUM);
            }
        }
        if (ConfigMaterial.GOLD.isNotOff()) {
            event.getRegistry().register(SEED_GOLD);
        }
        if (ConfigMaterial.IRON.isNotOff()) {
            event.getRegistry().register(SEED_IRON);
        }
        if (ConfigMaterial.LEAD.isNotOff()) {
            event.getRegistry().register(SEED_LEAD);
        ...
        if (ConfigMaterial.MITHRIL.isNotOff()) {
            event.getRegistry().register(SEED_MITHRIL);
            if (ConfigMaterial.MITHRIL.mustLoad()) {
                event.getRegistry().register(BLOCK_MITHRIL);
            }
        }
        if (ConfigMaterial.NICKEL.isNotOff()) {
            event.getRegistry().register(SEED_NICKEL);
        ...
        if (ConfigMaterial.SILVER.isNotOff()) {
            event.getRegistry().register(SEED_SILVER);
            if (ConfigMaterial.SILVER.mustLoad()) {
                event.getRegistry().register(BLOCK_SILVER);
                event.getRegistry().register(ORE_SILVER);
            }
        }
        if (ConfigMaterial.TIN.isNotOff()) {
            event.getRegistry().register(SEED_TIN);
            if (ConfigMaterial.TIN.mustLoad()) {
                event.getRegistry().register(BLOCK_TIN);
                event.getRegistry().register(ORE_TIN);
            }
        }
        if (ConfigMaterial.UMBERSTEEL.isNotOff()) {
            if (ConfigMaterial.UMBERSTEEL.mustLoad()) {
                event.getRegistry().register(BLOCK_UMBER_STEEL);
            }
        }
    }
}
